...
public class RecyclerViewReportedAdapterAll extends RecyclerView.Adapter<RecyclerViewReportedAdapterAll.ViewHolder> {

    private LayoutInflater mInflater;
    private RecyclerViewReportedAdapterAll.ItemClickListener mClickListener;
    private List<String> reportedSitesList;

    public RecyclerViewReportedAdapterAll(Context context, List<String> data) {
